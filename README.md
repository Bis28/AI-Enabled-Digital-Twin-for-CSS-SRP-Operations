...
This project was developed for the **Smart India Hackathon (SIH) - Oil India Limited (OIL)** problem statement. It is a robust, physics-driven SCADA dashboard that integrates reservoir thermodynamics, kinematic mechanical constraints, and an Explainable AI (XAI) Copilot.
